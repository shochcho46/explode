...
<div class="mt-2 row">
    <div class="col card p-2 text-center elegant-color amber-text  m-2 ">
...
<div class="row mt-3">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 ">
        <div class="card m-2 elegant-color-dark">
                ...
                <div class="md-form p-2">
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="btn-floating btn-elegant"><i
...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
    <div class="card m-2 p-3 elegant-color-dark">

        <div class="text-center p-4">
            <button type="submit" class=" btn btn-amber btn-rounded btn-block">UPLOAD</button>
        </div>
