...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        ...
        <form method="POST" id="secuirity" action="{{ route('confirmpass',$user->id) }}"
            ...
            <div class="card elegant-color-dark mb-3">
                ...
                <div class="card-body px-lg-5 pt-0">
                    ...
                    <div class="md-form">
                        <input type="text" id="resetcode" name="resetcode" class="form-control white-text"   required>
                        <label for="resetcode" class=" white-text">Code</label>
