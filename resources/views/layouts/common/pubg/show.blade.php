    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      ...
      <ul class="nav md-pills nav-justified pills-amber elegant-color-dark white-text mb-4">
        <li class="nav-item pl-0">
          <a class="nav-link white-text active " data-toggle="tab" href="#registration" role="tab">Registration</a>
        </li>
        <li class="nav-item pl-0">
          <a class="nav-link white-text " data-toggle="tab" href="#rule" role="tab">Rules</a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content card elegant-color-dark">
        ...
        @include('layouts.common.pubg.form')
