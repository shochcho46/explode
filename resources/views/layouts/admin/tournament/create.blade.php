                            ...
                            <div class="card-body px-lg-5">
                                    ...
                                    <select name ="game_id" class="mdb-select colorful-select dropdown-dark white-text" searchable="Search here.." required>
                                        ...
                                        @foreach($data as $key => $value)
                                                ...
                                                <option value="{{$value->id}}">{{$value->game_name}}</option>
                                          @endforeach
                                    ...
                                    <div class="md-form mt-3">
                                        <input type="text" id="tournament_name" name="tournament_name"  placeholder="Tournament Name" value="{{ old('tournament_name') }}"required class="form-control white-text">
                                    ...
                                    <div class="md-form">
                                        <input type="number" id="total" name="total" placeholder="Total team/player" value="{{ old('total') }}" required min="1" class="form-control white-text">
                                    ...
                                    @include('layouts.common.pagepart.datetimecreate')
