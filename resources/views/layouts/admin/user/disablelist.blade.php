...
<div class="container-fluid">
 ...
 <h4 class="text-center amber-text mt-2">{{ $heading }}</h4>
 ...
 <div class="table-responsive m-3">
    <table class="table text-center">
        ...
        <tbody>
            ...
            <tr>
                 <td class="white-text">{{ $user->firstItem() + $key }}</td>


                <td class="white-text">{{ $value->name }}</td>
                <td class="white-text">{{ $value->type }}</td>
                ...
                <td>
                    ...
                    <a class="btn-floating btn-sm btn-amber"  href="{{ route('admin.activeuser',$value->id) }}" onclick="event.preventDefault(); document.getElementById('disa{{$value->id}}').submit();">
