...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2021 at 10:48 PM
...
INSERT INTO `games` (`id`, `game_name`, `serial`, `status`, `location`, `created_at`, `updated_at`) VALUES
(1, 'PUBG', '1', 'active', 'http://127.0.0.1:8000/storage/game/1623368989.jpg', '2021-06-10 23:49:49', '2021-06-10 23:49:49');
...
(32, '2021_06_12_165326_create_rules_table', 3);
...
INSERT INTO `rules` (`id`, `tournament_id`, `description`, `created_at`, `updated_at`) VALUES
(1, 2, '<h2>More Colors Option and Color Dialog</h2>\r\n\r\n<p>You can also add an optional&nbsp;<a href=\"https://ckeditor.com/cke4/addon/colordialog\">Color Dialog</a>&nbsp;plugin which provides the&nbsp;<strong>More Colors</strong>&nbsp;option and a user-friendly way to select the desired color through a dedicated dialog window. The editor instance below includes both features. Notice how the picked colors are saved in the color history row below the default palette for easy reuse.</p>\r\n\r\n<p>You can also add an <strong>optional&nbsp;<a href=\"https://ckeditor.com/cke4/addon/colordialog\">Color Dialog</a>&nbsp;plugin which provides the&nbsp;More Colors&nbsp;option and a user-friendly way to select the desired color through a dedicated dialog window. The editor instance below includes both features. Notice how the </strong>picked colors are saved in the color history row below the default palette for easy reuse.</p>', '2021-06-12 11:45:04', '2021-06-12 12:08:20');
...
INSERT INTO `tournaments` (`id`, `game_id`, `user_id`, `tournament_name`, `serial`, `total`, `status`, `location`, `pin`, `updateby`, `registration`, `enddate`, `created_at`, `updated_at`) VALUES
(2, 1, 1, 'PMRT - 2021', '1', '5', 'active', 'http://127.0.0.1:8000/storage/tournament/1623399420.jpg', 'disable', NULL, 'active', '2021-06-15 14:21:00', '2021-06-11 08:17:00', '2021-06-11 08:17:00');
...
(27, 'MD.SADMAN SHAKIB', 't@t.com', NULL, '01558525406', '$2y$10$3SiMeTyiS1FGRLLWjEfZWuOuglqe5869d0sBuXhP/SF35PyiJMDS6', NULL, NULL, 'normal', 'active', NULL, '2021-06-11 20:28:14', '2021-06-11 20:28:14');
...
ALTER TABLE `rules`
  ADD PRIMARY KEY (`id`),
  ADD KEY `rules_tournament_id_foreign` (`tournament_id`);
...
--
ALTER TABLE `rules`
  ADD CONSTRAINT `rules_tournament_id_foreign` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments` (`id`);
